...
test.describe("wasix-worker-bridge", () => {
  ...
  //
  // The CLOCK_NOW test above proves the SAB state machine end-to-end. This
  // proves that the encoder and decoder for the *other* new opcode are
  ...
  // payload byte) passes CLOCK_NOW's coverage and current CI untouched. The
